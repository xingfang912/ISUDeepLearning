"""
This tutorial introduces a convolutional neural network (C-CP-C-CP-FC)
...
class CNN(object):
    ...
    def __init__(self,
        ...
        next_layer_input = layer3.output.flatten(2)

        # dropout the input
        next_dropout_layer_input = dropout_from_layer(rng, layer3.output.flatten(2), p=dropout_rates[0])
        layer_counter = 0        
...
if __name__ == '__main__':
    ...
    n_epochs = 70
    batch_size = None
    nkerns = [64, 64, 128, 128]

    #feature map sizes = [224,222,110,108,53]
    mlp_layer_sizes = [ nkerns[-1]*53*53, 500, -1 ] # -1 = num classes. not known initially.
